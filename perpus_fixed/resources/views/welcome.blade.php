    ...
    <div>
      ...
      <section id="genre" aria-label="Jelajahi genre" style="padding-top:44px">
        ...
        <div class="ggrid" role="tabpanel">
          <a href="{{ route('user.books.index', ['category' => 'sastra-indonesia']) }}" class="gtile" data-g="sastra" tabindex="0"><div class="gtile-icon" style="background:rgba(28,107,70,.1)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--green)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></div><div class="gtile-name">Sastra Indonesia</div><div class="gtile-count">320 buku</div><div class="gtile-n">Sas</div></a>
          <a href="{{ route('user.books.index', ['category' => 'sejarah']) }}" class="gtile" data-g="sejarah" tabindex="0"><div class="gtile-icon" style="background:rgba(208,78,26,.1)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10z"/></svg></div><div class="gtile-name">Sejarah & Budaya</div><div class="gtile-count">185 buku</div><div class="gtile-n">Sej</div></a>
          <a href="{{ route('user.books.index', ['category' => 'sains']) }}" class="gtile" data-g="sains" tabindex="0"><div class="gtile-icon" style="background:rgba(60,100,200,.08)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4060B0" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/></svg></div><div class="gtile-name">Sains & Teknologi</div><div class="gtile-count">218 buku</div><div class="gtile-n">Tek</div></a>
          <a href="{{ route('user.books.index', ['category' => 'self-help']) }}" class="gtile" data-g="selfhelp" tabindex="0"><div class="gtile-icon" style="background:rgba(230,168,23,.1)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#c89a14" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4z"/></svg></div><div class="gtile-name">Pengembangan Diri</div><div class="gtile-count">274 buku</div><div class="gtile-n">Dev</div></a>
          <a href="{{ route('user.books.index', ['category' => 'fiksi-ilmiah']) }}" class="gtile" data-g="fiksi" tabindex="0"><div class="gtile-icon" style="background:rgba(130,60,200,.08)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#7040B0" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg></div><div class="gtile-name">Fiksi Ilmiah</div><div class="gtile-count">156 buku</div><div class="gtile-n">Fk</div></a>
          <a href="{{ route('user.books.index', ['category' => 'filsafat']) }}" class="gtile" data-g="filsafat" tabindex="0"><div class="gtile-icon" style="background:rgba(208,78,26,.08)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M20.3 17.3a2 2 0 0 0 .7-1.5v-7.6a2 2 0 0 0-.7-1.5L16 3.3a2 2 0 0 0-1.5-.3h-5A2 2 0 0 0 8 3.3L3.7 6.7a2 2 0 0 0-.7 1.5v7.6a2 2 0 0 0 .7 1.5L8 20.7a2 2 0 0 0 1.5.3h5a2 2 0 0 0 1.5-.3z"/></svg></div><div class="gtile-name">Filsafat</div><div class="gtile-count">98 buku</div><div class="gtile-n">Fil</div></a>
          <a href="{{ route('user.books.index', ['category' => 'agama']) }}" class="gtile" data-g="agama" tabindex="0"><div class="gtile-icon" style="background:rgba(28,107,70,.08)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--green)" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></div><div class="gtile-name">Agama & Spiritual</div><div class="gtile-count">143 buku</div><div class="gtile-n">Aga</div></a>
          <a href="{{ route('user.books.index', ['category' => 'hukum']) }}" class="gtile" data-g="sains" tabindex="0"><div class="gtile-icon" style="background:rgba(60,100,200,.08)"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4060B0" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div><div class="gtile-name">Hukum & Politik</div><div class="gtile-count">89 buku</div><div class="gtile-n">Hkm</div></a>
        </div>
      </section>
    </div>
